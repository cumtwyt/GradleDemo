...
public class Cart implements Serializable{
	...
	public String getCart_gid() {
		return cart_gid;
	}


	public void setCart_gid(String cart_gid) {
	...
	public String toString() {
		return "Cart [cart_id=" + cart_id + ",cart_gid="+cart_gid+", cart_name=" + cart_name + ", cart_number="
				+ cart_number + ",cart_price="+cart_price+",cart_image="+cart_image+"]";
	}
