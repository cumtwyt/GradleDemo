...
public interface GoodMapper {
	...
	@Select("update tb_good set good_price=#{price},good_remark=#{remark},good_image=#{image} where good_id=#{id}")
	Good updategood(@Param("id")String id,@Param("price")String price,@Param("remark")String remark,@Param("image")String image);
