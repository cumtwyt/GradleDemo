		...
		<div class="gtco-container">
			<div class="row">
				...
				<div class="col-xs-8 text-center menu-1">
					<p style="font-size:30px;color:#ffffff;font-family: 华文行楷;">各“书”己见--删除评论</p>
				</div>
			</div>
			...
			<div class="container">
				<div class="row row-bottom-padded-md">
					<div class="col-md-6 col-md-offset-3 text-center">
						<h2 class="fh5co-lead animate-box">Delete The Information</h2>
						<p class="fh5co-sub-lead animate-box">信息删除</p>
					</div>
				</div>
									...
									<form action="deletecom" method="post">
										<div class="row form-group">
											...
											<!--  <div class="col-md-12">
												...
												<input type="text" id="goodname" class="form-control" placeholder="Goodname" name="good_name">
											</div>-->
										</div>
										<div class="form-group">
											<center><input type="submit" value="立即删除" class="form-control" style="margin-top:40px;background: #52d3aa;color: #fff;border: 2px solid #52d3aa;"></center>
										</div>
									</form>		
								</div>
